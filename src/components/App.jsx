...
class App extends React.Component {
  constructor(props) {
    ...
    this.handleChangingSelectedStore = this.handleChangingSelectedStore.bind(this);
      ...
      <div>
        ...
        <div>
          <Switch>
            ...
            <Route path='/dishes' render={() =><Dishes dishes={this.state.masterDishes} onDishSelection={this.handleChangingSelectedDish} />} />
            ...
            <Route path='/foods' render={() =><Foods foods={this.state.masterFoods} dishes={this.state.masterDishes} stores={this.state.masterStores} onFoodSelection={this.handleChangingSelectedFood} />} />
            <Route path='/addfood' render={() =><AddFoodForm dishes={this.state.masterDishes} stores={this.state.masterStores} onNewFoodCreation={this.handleAddingNewFood} />} />
            <Route path='/deletefood' render={() =><DeleteFoodForm onFoodDeletion={this.handleDeletingFood} selectedFood={this.state.selectedFood} />} />
            <Route path='/editfood' render={() =><EditFoodForm dishes={this.state.masterDishes} stores={this.state.masterStores} onFoodUpdate={this.handleEditingFood} selectedFood={this.state.selectedFood} selectedFoodProps={this.state.selectedFoodProps} />} />
            <Route path='/searchfoods' component={SearchFoods} />

            <Route path='/stores' render={() =><Stores stores={this.state.masterStores} onStoreSelection={this.handleChangingSelectedStore} />} />
            <Route path='/addstore' render={() =><AddStoreForm onNewStoreCreation={this.handleAddingNewStore} />} />
            <Route path='/deletestore' render={() =><DeleteStoreForm onStoreDeletion={this.handleDeletingStore} selectedStore={this.state.selectedStore} />} />
            <Route path='/editstore' render={() =><EditStoreForm onStoreUpdate={this.handleEditingStore} selectedStore={this.state.selectedStore} selectedStoreProps={this.state.selectedStoreProps} />} />
            <Route path='/searchstores' component={SearchStores} />

            <Route path='/tasks' render={() =><Tasks tasks={this.state.masterTasks} onTaskSelection={this.handleChangingSelectedTask} />} />
            <Route path='/addtask' render={() =><AddTaskForm onNewTaskCreation={this.handleAddingNewTask} />} />
            <Route path='/deletetask' render={() =><DeleteTaskForm onTaskDeletion={this.handleDeletingTask} selectedTask={this.state.selectedTask} />} />
            <Route path='/edittask' render={() =><EditTaskForm onTaskUpdate={this.handleEditingTask} selectedTask={this.state.selectedTask} selectedTaskProps={this.state.selectedTaskProps} />} />
            <Route path='/searchtasks' component={SearchTasks} />

            <Route path='/invitees' render={() =><Invitees invitees={this.state.masterInvitees} onInviteeSelection={this.handleChangingSelectedInvitee} />} />
            <Route path='/addinvitee' render={() =><AddInviteeForm onNewInviteeCreation={this.handleAddingNewInvitee} />} />
            <Route path='/deleteinvitee' render={() =><DeleteInviteeForm onInviteeDeletion={this.handleDeletingInvitee} selectedInvitee={this.state.selectedInvitee} />} />
