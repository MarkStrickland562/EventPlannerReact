    ...
    <div>
      ...
      <div>
        ...
        <div style-={{paddingRight: '5%'}} className="page-content">
          ...
          <button type="button" className="button-main"><Link className="link" to="/searchrecipes">SEARCH AGAIN</Link></button>
          <br></br>
          <div className="parentColumn">
            {Object.keys(props.recipes).map(function(recipeId) {
              var recipe = props.recipes[recipeId];
              return <div className="column" key={recipeId}>
                <div>
                  <Recipe recipeImage={recipe.recipe.image}
